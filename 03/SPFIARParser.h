...
/** ----------- My function --------
 * Casts a command string into an SP_COMMAND type variable.
 *
 * @return
 * A SP_COMMAND type variable of the proper value.
 * if the command string doesn't match any other object in the Enum group
 * return the object "SP_INVALID_LINE"
 */
