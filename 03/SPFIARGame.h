...
/**
* Switches between player turn
* @param src - the source game
*/
void switchPlayer(SPFiarGame *src);

/**
* Compute the score function for a given game state
* @param src - the source game
* @return
* Array of ints representing a histogram of possible 4 spans
*/
int* computeScoreHistogram(SPFiarGame * game, int *scoreHist);


/**
* Compute the score function only for row spans and update the histogram array
* @param src - the source game , Histogram - the array to update
* @return
*/
...
/**
* Compute the score function only for column spans and update the histogram array
* @param src - the source game , Histogram - the array to update
* @return
*/
...
/**
* Compute the score function only for right cross spans //// and update the histogram array
* @param src - the source game , Histogram - the array to update
* @return
*/
...
/**
* Compute the score function only for left cross spans \\\\\ and update the histogram array
* @param src - the source game , Histogram - the array to update
* @return
*/
...
/**
* Compute the score function from a given histogarm using the vector weight
* [-5, -2, -1, 0, 1, 2, 5] or IntMax or IntMin if there is a winner.
* @param src - the source game , Histogram - the array to update
* @return
*/
